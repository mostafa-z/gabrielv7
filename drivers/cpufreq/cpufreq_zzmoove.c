...
static int input_dev_filter(const char *input_dev_name)
{
	if (strstr(input_dev_name, "sec_touchscreen") ||
		...
		strstr(input_dev_name, "s2s_pwrkey") ||						// ZZ: G3 power key?
		strstr(input_dev_name, "msm8974-taiko-mtp-snd-card Button Jack") ||		// ZZ: G3 sound button?
		strstr(input_dev_name, "msm8974-taiko-mtp-snd-card Headset Jack") ||		// ZZ: G3 headset jack
		strstr(input_dev_name, "synaptics-rmi-ts") ||					// ZZ: G3 touchscreen
